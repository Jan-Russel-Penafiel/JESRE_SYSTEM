...
$DEPARTMENT_CONFIG = [
    ...
    'production' => [
        ...
        'workflow_points' => [
            ...
            'Record quantity prepared for inventory stock deduction.',
        ...
        'fields' => [
            ...
            ['name' => 'ingredient_item_ids', 'label' => 'Ingredient Selections', 'type' => 'inventory_multi_select', 'required' => true],
            ['name' => 'notes', 'label' => 'Notes', 'type' => 'textarea', 'required' => false],
        ],
        'list_columns' => [
            'Beverage' => 'beverage_name',
            'Ingredient Selections' => 'ingredient_item_ids',
    ...
    'sales' => [
        ...
        'workflow_points' => [
            ...
            'Each approved order automatically updates CRM records.',
        ...
        'list_columns' => [
            ...
            'Beverage' => 'beverage_name',
            'Ingredients' => 'ingredient_item_ids',
            'Qty' => 'quantity',
