...
$DEPARTMENT_CONFIG = [
    'purchasing' => [
        ...
        'fields' => [
            ...
            ['name' => 'requested_qty', 'label' => 'Stock Quantity', 'type' => 'number', 'step' => '0.01', 'required' => true],
    ...
    'production' => [
        ...
        'description' => 'Log daily beverage production. Records are locked immediately after saving and cannot be edited or deleted.',
        'create_button_label' => 'Log Daily Production',
        'submit_label' => 'Save Production Log',
        'edit_label' => 'Save Changes',
        'workflow_points' => [
            'Input the daily quantity prepared per beverage flavor.',
            'Ingredients are auto-deducted from inventory on save.',
            'Production records are locked after saving — no edits or deletions allowed.',
        ],
    ...
    'sales' => [
        ...
        'description' => 'Record customer sales against today\'s production stock. Payment is cash only. Each sale auto-updates accounting and CRM.',
        'create_button_label' => 'New Sale',
        'submit_label' => 'Save Sale',
        'edit_label' => 'Save Changes',
        'workflow_points' => [
            'Record buyer name, beverage, and quantity.',
            'System checks today\'s production stock before saving.',
            'Sale auto-creates income and COGS accounting entries.',
        ],
